...
import type { InboundWebSocket as SDKInboundWebSocket, WebSocketRequest as SDKWebSocketRequest } from '@songloft/plugin-sdk';
...
type HostWebSocketRequest = SDKWebSocketRequest;
type HostInboundWebSocket = SDKInboundWebSocket;
...
export async function handleLxSyncWebSocket(
  req: HostWebSocketRequest,
  socket: HostInboundWebSocket,
